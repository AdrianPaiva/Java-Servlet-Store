    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameterMap().containsKey("viewAll")) {
                ...
                request.setAttribute("catalog", c.getCatalog());
                address = "admin.jsp";
            }
            else if(request.getParameterMap().containsKey("addProduct"))
            {
                address = "addProduct.jsp";
            }
            else if(request.getParameterMap().containsKey("addCategory"))
            {
